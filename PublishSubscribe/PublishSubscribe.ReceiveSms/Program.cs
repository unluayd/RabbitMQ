...
namespace PublishSubscribe.Sms;
...
internal class Program
{
    ...
    static async Task Main(string[] args)
    {
        ...
        // Kullaniciya artik SMS bildirimi beklenmeye baslandigini bildirir.
        Console.WriteLine(" [*] Waiting for SMS logs.");
        ...
        consumer.ReceivedAsync += async (_, ea) =>
        {
            ...
            // SMS servisine gidiyormus gibi mesaji ekrana yazar.
            Console.WriteLine($" [x] SMS sent: {message}");
