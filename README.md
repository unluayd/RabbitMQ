...
Bu projeleri GitHub'daki `unluayd/RabbitMQ` reposuna yuklemek icin asagidaki adimlari izleyebilirsiniz:

```bash
cd /home/lenovo/Desktop/RabbitMQ
git init
git branch -M main
git remote add origin https://github.com/unluayd/RabbitMQ.git
git add .
git commit -m "Add RabbitMQ training projects and README"
git push -u origin main
```

Eger remote daha once eklenmisse, tekrar `git remote add origin ...` yerine su komutla kontrol edebilirsiniz:
